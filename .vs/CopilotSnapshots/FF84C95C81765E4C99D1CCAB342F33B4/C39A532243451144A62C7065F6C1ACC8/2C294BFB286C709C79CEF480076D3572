...
namespace AutoZone.Controllers
{
    public class BrandModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,RegisterOn")] BrandModel brandModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,RegisterOn")] BrandModel brandModel)
        {
            if (id != brandModel.Id)
            {
                return NotFound();
